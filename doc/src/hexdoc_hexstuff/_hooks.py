...
import hexdoc_hexstuff

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexStuffPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexStuffModPlugin(branch=branch)


class HexStuffModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexstuff"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexstuff, "_templates"
